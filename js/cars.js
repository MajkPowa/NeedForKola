...
(function (global) {
  ...
  const CARS = [
    {
      id: 'gt', name: 'GT COUPE', tag: 'Sportovní kupé', fits: 'Porsche 911 / Cayman / Boxster',
    ...
    {
      id: 'suv', name: 'PERFORMANCE SUV', tag: 'Sportovní SUV', fits: 'VW Tiguan / Touareg, Audi Q5 / Q8, BMW X5 / X6',
    ...
    {
      id: 'hatch', name: 'HOT HATCH', tag: 'Ostrý hatchback', fits: 'VW Golf R / GTI, Audi RS 3 / S3, Škoda Octavia RS, Cupra Leon',
    ...
    {
      id: 'muscle', name: 'MUSCLE GT', tag: 'Americký muscle car', fits: 'Ford Mustang GT / Shelby (2005 a novější)',
    ...
    {
      id: 'hyper', name: 'HYPERCAR', tag: 'Supersport', fits: 'Lamborghini Huracán / Gallardo, Audi R8',
    ...
    {
      id: 'jdm', name: 'JDM LEGEND', tag: 'Japonská legenda', fits: 'Nissan GT-R / 370Z / Skyline, Infiniti Q50 / Q60',
  ...
  function carSVG(car, bodyHex, wheelOpts, idp, opts) {
    ...
    const wo = Object.assign({}, wheelOpts || {}, { spin: opts.spin || 0 });
    const wheel = (x, id) => `<g transform="translate(${x} ${cy}) scale(${(w.r / 100).toFixed(3)})">${O.wheelGroup(wo, id, 0)}</g>`;
